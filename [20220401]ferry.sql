...
CREATE TABLE `sys_api`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键编码',
...
INSERT INTO `sys_api` VALUES (21, 'go-admin/app/admin/apis.SysDictType.GetPage-fm', '字典类型列表', '/api/v1/dict/type', 'BUS', 'GET', '2021-05-13 19:59:01.525', '2022-03-11 10:01:54.152', NULL, 0, 0);
...
INSERT INTO `sys_api` VALUES (26, 'go-admin/app/admin/apis.SysDictData.GetSysDictDataAll-fm', '数据字典根据key获取', '/api/v1/dict-data/option-select', 'SYS', 'GET', '2021-05-13 19:59:01.832', '2022-03-11 10:01:54.152', NULL, 0, 0);
INSERT INTO `sys_api` VALUES (27, 'go-admin/app/admin/apis.SysDept.GetPage-fm', '部门列表', '/api/v1/dept', 'BUS', 'GET', '2021-05-13 19:59:01.940', '2022-03-11 10:01:44.298', NULL, 0, 0);
...
INSERT INTO `sys_api` VALUES (44, 'go-admin/app/admin/apis.SysRole.GetPage-fm', '角色列表', '/api/v1/role', 'BUS', 'GET', '2021-05-13 19:59:02.720', '2022-03-11 10:01:00.164', NULL, 0, 0);
...
INSERT INTO `sys_api` VALUES (53, 'go-admin/app/admin/apis.SysConfig.GetPage-fm', '参数列表', '/api/v1/config', 'BUS', 'GET', '2021-05-13 19:59:03.116', '2022-03-11 10:02:02.455', NULL, 0, 0);
...
INSERT INTO `sys_api` VALUES (59, 'go-admin/app/admin/apis.SysPost.GetPage-fm', '岗位列表', '/api/v1/post', 'BUS', 'GET', '2021-05-13 19:59:03.381', '2022-03-11 10:01:12.307', NULL, 0, 0);
...
INSERT INTO `sys_api` VALUES (135, 'go-admin/app/admin/apis.SysApi.GetPage-fm', '接口列表', '/api/v1/sys-api', 'BUS', 'GET', '2021-05-24 11:37:53.303', '2022-03-29 10:08:04.195', NULL, 0, 0);
...
INSERT INTO `sys_api` VALUES (140, 'go-admin/app/admin/apis.SysConfig.Get2Set-fm', '参数获取全部【配置使用】', '/api/v1/set-config', 'BUS', 'GET', '2021-05-27 11:54:14.384', '2022-03-11 10:00:49.527', NULL, 0, 0);
INSERT INTO `sys_api` VALUES (141, 'go-admin/app/admin/apis.SysUser.GetPage-fm', '管理员列表', '/api/v1/sys-user', 'BUS', 'GET', '2021-06-13 19:24:57.111', '2022-03-29 10:06:16.993', NULL, 0, 0);
...
-- ----------------------------
-- Table structure for sys_background
-- ----------------------------
DROP TABLE IF EXISTS `sys_background`;
CREATE TABLE `sys_background`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `uid` int(0) NULL DEFAULT NULL COMMENT '上传人',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `size` int(0) NULL DEFAULT NULL COMMENT '文件大小',
  `cover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图片地址',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图片类型',
  `status` int(0) NULL DEFAULT 0 COMMENT '是否启用',
  `created_at` timestamp(3) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_background
-- ----------------------------
INSERT INTO `sys_background` VALUES (1, NULL, '依布1', NULL, 'http://piccn.ihuaben.com/pic/chapter/202002/0800/1581094221085-e53Fq88V7k_1280-1112.jpeg', NULL, 0, NULL);
INSERT INTO `sys_background` VALUES (2, NULL, '依布2', NULL, 'http://hbimg.huabanimg.com/11e3f94969c2402be53c850a24573dd9671f71178546d-vSGb5z_fw658', NULL, 0, NULL);
...
CREATE TABLE `sys_casbin_rule`  (
  ...
  UNIQUE INDEX `idx_sys_casbin_rule`(`p_type`, `v0`, `v1`, `v2`, `v3`, `v4`, `v5`) USING BTREE
...
CREATE TABLE `sys_code`  (
  ...
  `code` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of sys_code
-- ----------------------------
INSERT INTO `sys_code` VALUES (10, '15891223853', '700675', '2022-03-14 12:06:51');
INSERT INTO `sys_code` VALUES (17, '17717356757', '257142', '2022-03-14 16:06:02');
INSERT INTO `sys_code` VALUES (18, '15901945155', '710433', '2022-03-24 16:10:11');
INSERT INTO `sys_code` VALUES (19, '17717356757', '489196', '2022-03-14 17:03:33');
INSERT INTO `sys_code` VALUES (20, '17717356757', '433110', '2022-03-14 17:25:28');
INSERT INTO `sys_code` VALUES (21, '17717356757', '296653', '2022-03-15 16:54:01');
INSERT INTO `sys_code` VALUES (22, '17717356757', '566817', '2022-03-16 09:08:40');
INSERT INTO `sys_code` VALUES (23, '15901945151', '123456', '2022-03-25 00:33:06');
...
INSERT INTO `sys_config` VALUES (4, '系统名称', 'sys_app_name', 'DGMetaverse管理系统', 'Y', '1', '', 1, 0, '2021-03-17 08:52:06.067', '2022-03-03 10:37:46.586', NULL);
...
-- ----------------------------
-- Table structure for sys_decorate
-- ----------------------------
DROP TABLE IF EXISTS `sys_decorate`;
CREATE TABLE `sys_decorate`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `typeid` int(0) NULL DEFAULT NULL COMMENT '类型',
...
-- ----------------------------
-- Records of sys_decorate
-- ----------------------------
INSERT INTO `sys_decorate` VALUES (1, 11, 11, '11', '11', 1, '2022-03-31 15:14:25.000');
INSERT INTO `sys_decorate` VALUES (2, 22, 22, '22', '22', 0, '2022-03-31 15:14:42.000');

-- ----------------------------
-- Table structure for sys_decoratecate
-- ----------------------------
DROP TABLE IF EXISTS `sys_decoratecate`;
CREATE TABLE `sys_decoratecate`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `uid` int(0) NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of sys_decoratecate
-- ----------------------------
INSERT INTO `sys_decoratecate` VALUES (1, 1, '2222', 2, '2022-03-31 17:53:08.000');
INSERT INTO `sys_decoratecate` VALUES (2, 2, '2', 2, '2022-03-31 17:53:17.000');
INSERT INTO `sys_decoratecate` VALUES (3, 3, '3', 3, '2022-03-31 17:53:31.000');
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (1, 0, '/0/1/', '测试', 0, 'test', '18737521420', 'xxxx@dgene.com', 2, 1, 1, '2021-05-13 19:56:37.913', '2022-03-03 10:17:53.218', NULL);
...
INSERT INTO `sys_dept` VALUES (11, 0, '/0/11/', '会员用户', 10, 'xxxxxx', '15901945100', 'xxxxx@dgene.com', 2, 0, 0, '2022-03-03 10:20:47.140', '2022-03-03 10:21:09.405', NULL);
...
CREATE TABLE `sys_dict_data`  (
  ...
  `dict_sort` bigint(0) NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for sys_digital
-- ----------------------------
DROP TABLE IF EXISTS `sys_digital`;
CREATE TABLE `sys_digital`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `uid` int(0) NULL DEFAULT NULL,
  `cover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '数字人封面',
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `status` int(0) NULL DEFAULT 0,
  `created_at` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Records of sys_digital
-- ----------------------------
INSERT INTO `sys_digital` VALUES (1, 4, 'https://y.qq.com/music/photo_new/T001R300x300M0000025NhlN2yWrP4.jpg?max_age=2592000', 'https://y.qq.com/n/ryqq/singer/0025NhlN2yWrP4', 0, '2022-03-16 03:30:55');
INSERT INTO `sys_digital` VALUES (2, 4, 'https://y.qq.com/music/photo_new/T001R300x300M000003Nz2So3XXYek.jpg?max_age=2592000', 'https://y.qq.com/n/ryqq/singer/003Nz2So3XXYek', 0, '2022-03-16 11:31:13');
INSERT INTO `sys_digital` VALUES (3, 4, 'https://y.qq.com/music/photo_new/T001R300x300M000001BLpXF2DyJe2.jpg?max_age=2592000', 'https://y.qq.com/n/ryqq/singer/001BLpXF2DyJe2', 0, '2022-03-16 11:31:36');
...
CREATE TABLE `sys_feedback`  (
  ...
  `feedback` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '用户提交的图片集',
...
-- ----------------------------
INSERT INTO `sys_feedback` VALUES (1, 4, '[\"http://192.168.1.3:8000/static/uploadfile/b2cb73a9-e2f1-4cf2-aab6-3d3948b9102b.png\",\"http://192.168.1.3:8000/static/uploadfile/c9d0a3c9-518c-4c95-8550-2b4668cea84c.jpg\"]', '2022-03-23 01:16:20');
...
CREATE TABLE `sys_job`  (
  `job_id` bigint(0) NOT NULL AUTO_INCREMENT,
  ...
  `job_type` tinyint(0) NULL DEFAULT NULL,
  ...
  `misfire_policy` bigint(0) NULL DEFAULT NULL,
  `concurrent` tinyint(0) NULL DEFAULT NULL,
  `status` tinyint(0) NULL DEFAULT NULL,
  `entry_id` smallint(0) NULL DEFAULT NULL,
  `created_at` datetime(3) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime(3) NULL DEFAULT NULL COMMENT '最后更新时间',
  `deleted_at` datetime(3) NULL DEFAULT NULL COMMENT '删除时间',
  `create_by` bigint(0) NULL DEFAULT NULL COMMENT '创建者',
...
CREATE TABLE `sys_menu`  (
  ...
  `parent_id` smallint(0) NULL DEFAULT NULL,
...
INSERT INTO `sys_menu` VALUES (3, 'SysUserManage', '用户管理', 'user', '/admin/sys-user', '/0/2/3', 'C', '无', 'admin:sysUser:list', 2, 0, '', '/admin/sys-user/index', 0, '0', '1', 0, 1, '2021-05-20 22:08:44.526', '2022-03-29 10:06:16.991', NULL);
...
INSERT INTO `sys_menu` VALUES (52, 'SysRoleManage', '角色管理', 'peoples', '/admin/sys-role', '/0/2/52', 'C', '无', 'admin:sysRole:list', 2, 1, '', '/admin/sys-role/index', 20, '1', '1', 0, 1, '2021-05-20 22:08:44.526', '2022-03-11 10:01:00.163', NULL);
INSERT INTO `sys_menu` VALUES (56, 'SysDeptManage', '部门管理', 'tree', '/admin/sys-dept', '/0/2/56', 'C', '无', 'admin:sysDept:list', 2, 0, '', '/admin/sys-dept/index', 40, '1', '1', 0, 1, '2021-05-20 22:08:44.526', '2022-03-11 10:01:44.295', NULL);
INSERT INTO `sys_menu` VALUES (57, 'SysPostManage', '岗位管理', 'pass', '/admin/sys-post', '/0/2/57', 'C', '无', 'admin:sysPost:list', 2, 0, '', '/admin/sys-post/index', 50, '1', '1', 0, 1, '2021-05-20 22:08:44.526', '2022-03-11 10:01:12.306', NULL);
INSERT INTO `sys_menu` VALUES (58, 'Dict', '字典管理', 'education', '/admin/dict', '/0/2/58', 'C', '无', 'admin:sysDictType:list', 2, 0, '', '/admin/dict/index', 60, '1', '1', 0, 1, '2021-05-20 22:08:44.526', '2022-03-11 10:01:54.149', NULL);
...
INSERT INTO `sys_menu` VALUES (62, 'SysConfigManage', '参数管理', 'swagger', '/admin/sys-config', '/0/2/62', 'C', '无', 'admin:sysConfig:list', 2, 0, '', '/admin/sys-config/index', 70, '1', '1', 0, 1, '2021-05-20 22:08:44.526', '2022-03-11 10:02:02.453', NULL);
...
INSERT INTO `sys_menu` VALUES (528, 'SysApiManage', '接口管理', 'api-doc', '/admin/sys-api', '/0/527/528', 'C', '无', 'admin:sysApi:list', 2, 0, '', '/admin/sys-api/index', 100, '0', '0', 0, 1, '2021-05-20 22:08:44.526', '2022-03-29 10:08:04.194', NULL);
...
INSERT INTO `sys_menu` VALUES (540, 'SysConfigSet', '参数设置', 'system-tools', '/admin/sys-config/set', '', 'C', '', 'admin:sysConfigSet:list', 2, 0, '', '/admin/sys-config/set', 0, '1', '1', 1, 1, '2021-05-25 16:06:52.560', '2022-03-11 10:00:49.525', NULL);
...
INSERT INTO `sys_menu` VALUES (543, '', '妆扮管理', 'chart', '/decorate', '', 'M', '', '', 2, 0, '', '/decorate/index', 1, '0', '1', 1, 1, '2022-03-09 15:33:57.205', '2022-03-29 10:06:38.097', NULL);
INSERT INTO `sys_menu` VALUES (544, 'SysDecorateListManage', '妆扮列表', '', '/admin/sys-decorate-list', '', 'C', '', 'admin:sysDecorateList:list', 543, 0, '', '/admin/sys-decorate-list/index', 0, '0', '1', 1, 1, '2022-03-09 15:35:14.137', '2022-03-11 09:53:46.240', NULL);
INSERT INTO `sys_menu` VALUES (545, 'sysDecorateCatManage', '妆扮分类', '', '/admin/sys-decoratecate/', '', 'C', '', 'admin:sysDecorateCat:list', 543, 0, '', '/admin/sys-decoratecate/index', 0, '0', '1', 1, 1, '2022-03-09 15:35:41.987', '2022-03-29 09:47:21.113', NULL);
INSERT INTO `sys_menu` VALUES (546, 'SysBackManage', '背景图片管理', 'star', '/admin/sys-back', '', 'C', '', 'admin:sysBack:list', 2, 0, '', '/admin/sys-back/index', 5, '0', '1', 1, 1, '2022-03-09 15:36:34.738', '2022-03-29 10:07:27.280', NULL);
INSERT INTO `sys_menu` VALUES (547, 'SysMusicManage', '背景音乐管理', '', '/admin/sys-music', '', 'C', '', 'admin:sysMusic:list', 2, 0, '', '/admin/sys-music/index', 4, '0', '1', 1, 1, '2022-03-09 15:36:56.596', '2022-03-29 10:07:21.136', NULL);
INSERT INTO `sys_menu` VALUES (548, 'SysVideoManager', '用户视频管理', '', '/admin/sys-video', '', 'C', '', 'admin:sysVideo:list', 2, 0, '', '/admin/sys-video/index', 2, '0', '1', 1, 1, '2022-03-09 15:37:27.296', '2022-03-29 10:06:55.073', NULL);
INSERT INTO `sys_menu` VALUES (549, 'sysDigitalManager', '数字人管理', '', '/admin/sys-digital', '', 'C', '', 'admin:sysDigital:list', 2, 0, '', '/admin/sys-digital/index', 3, '0', '1', 1, 1, '2022-03-29 09:55:57.813', '2022-03-29 10:07:05.088', NULL);
INSERT INTO `sys_menu` VALUES (550, 'SysFeedManager', '用户反馈', '', '/admin/sys-feed', '', 'C', '', 'admin:sysFeed:list', 2, 0, '', '/admin/sys-feed/index', 6, '0', '1', 1, 1, '2022-03-29 10:00:39.699', '2022-03-29 10:07:48.201', NULL);
...
CREATE TABLE `sys_menu_api_rule`  (
  `sys_menu_menu_id` bigint(0) NOT NULL,
  `sys_api_id` bigint(0) NOT NULL COMMENT '主键编码',
...
-- ----------------------------
INSERT INTO `sys_migration` VALUES ('1599190683659', '2022-03-02 18:24:49.099');
...
CREATE TABLE `sys_music`  (
  ...
  `duration` int(0) NULL DEFAULT NULL COMMENT '以秒为单位',
  `cover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '封面URL',
  `usedtimes` int(0) NULL DEFAULT NULL COMMENT '使用次数',
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '音频地址，可能是本地',
  `status` int(0) NULL DEFAULT 0 COMMENT '音频是否可用',
...
-- ----------------------------
INSERT INTO `sys_music` VALUES (1, '我们的纪念', '徐薇', 268, 'https://y.qq.com/music/photo_new/T002R300x300M000001H42rr2TE4bl_1.jpg?max_age=2592000', 1, 'https://dl.stream.qqmusic.qq.com/C400002T5sfz1aXiH2.m4a?guid=3142204888&vkey=F2F7EC7A10FF2E804E5D5BC505BC14B50E694E047D9903D03F0170D3BCA055A8E452503176B61B4E9F32534EFB222A58AF454EEA943EFF4E&uin=&fromtag=66', 0, '2022-03-15 09:43:44.000', NULL, NULL);
INSERT INTO `sys_music` VALUES (2, '感谢你曾来过', '周思涵', 250, 'https://y.qq.com/music/photo_new/T002R300x300M000000a933P3Ipjln_1.jpg?max_age=2592000', 2, 'https://dl.stream.qqmusic.qq.com/C4000030tUdm27Ptzv.m4a?guid=3994555846&vkey=BEEED83A3BE886008A9E2B58C87CB3ABC6D05FF4A4DEF7C70E14D44E75329E616AA0FBFD29CF9D623195A500607D319CA4FB0832AFDDD252&uin=&fromtag=66', 0, '2022-03-15 10:47:11.000', NULL, NULL);
INSERT INTO `sys_music` VALUES (3, '青柠', '桃十五', 199, 'https://y.qq.com/music/photo_new/T002R300x300M000000J7CRU2v2GLb_2.jpg?max_age=2592000', 3, 'https://dl.stream.qqmusic.qq.com/C400002Cu7KM4YBWvO.m4a?guid=9954900536&vkey=73C3AAEFFB433FC8A0521F1CC5DA20A2594E588FF9D2D9FD2693C7A8965B97E2F05DAAEEC3F77DAD443B0A84ACE1E789312E595277C77C4A&uin=&fromtag=66', 0, '2022-03-15 10:47:15.000', NULL, NULL);
...
CREATE TABLE `sys_opera_log`  (
  ...
  `request_method` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '请求方式',
  ...
  `status` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '操作状态',
...
CREATE TABLE `sys_role`  (
  ...
  `role_sort` bigint(0) NULL DEFAULT NULL,
...
CREATE TABLE `sys_role_dept`  (
  `role_id` smallint(0) NOT NULL,
  `dept_id` smallint(0) NOT NULL,
...
CREATE TABLE `sys_task`  (
  ...
  `height` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `weight` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `hash` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `status` int(0) NULL DEFAULT 0,
  `created_at` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  ` model_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '模型生成后的路径',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of sys_task
-- ----------------------------
INSERT INTO `sys_task` VALUES (2, 4, 1, 20, '170', '56.3', './temp/20220308/1646725682449533.jpeg', '53ae8f4817d3273bffa51886f2271c0e', 0, '2022-03-08 15:48:03', NULL);
INSERT INTO `sys_task` VALUES (3, 4, 1, 20, '171', '56.3', './temp/20220308/1646727196240133.jpeg', '77bc20cf107f572a542b6eb9cec22597', 0, '2022-03-08 16:13:17', NULL);
INSERT INTO `sys_task` VALUES (4, 4, 1, 20, '171', '56.4', './temp/20220308/f05acd7a7db1b66ece7e00db6d288ee7.jpeg', 'f05acd7a7db1b66ece7e00db6d288ee7', 0, '2022-03-08 16:15:04', NULL);
INSERT INTO `sys_task` VALUES (5, 4, 1, 20, '172', '56.4', './temp/20220309/a678067b45dda9e0a5234ad088ca8732.jpeg', 'a678067b45dda9e0a5234ad088ca8732', 0, '2022-03-09 09:45:01', NULL);
INSERT INTO `sys_task` VALUES (6, 4, 1, 20, '173', '56.4', './temp/20220315/f0483e5ec3918e3d59a800bbe51ae816.jpeg', 'f0483e5ec3918e3d59a800bbe51ae816', 0, '2022-03-15 16:17:28', NULL);
INSERT INTO `sys_task` VALUES (7, 4, 1, 20, '174', '56.4', './temp/20220316/af772f4b6ecf91c82f8e9b56244c807a.jpeg', 'af772f4b6ecf91c82f8e9b56244c807a', 0, '2022-03-16 08:55:59', NULL);
INSERT INTO `sys_task` VALUES (8, 4, 1, 20, '174', '56.4', './temp/20220316/40e109e6b1d3193ceff5b4cc28512e5b.jpeg', '40e109e6b1d3193ceff5b4cc28512e5b', 0, '2022-03-16 09:01:54', NULL);
...
CREATE TABLE `sys_user`  (
  `user_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编码',
  ...
  `post_id` bigint(0) NULL DEFAULT NULL COMMENT '岗位',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `status` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '状态',
  `create_by` bigint(0) NULL DEFAULT NULL COMMENT '创建者',
  `update_by` bigint(0) NULL DEFAULT NULL COMMENT '更新者',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$/Glr4g9Svr6O0kvjsRJCXu3f0W8/dsP3XZyVNi1019ratWpSPMyw.', '叠境数字', '13818888888', 1, '', '', '1', '1@qq.com', 1, 1, '', '2', 1, 1, '2021-05-13 19:56:37.914', '2022-03-03 10:34:04.275', NULL);
INSERT INTO `sys_user` VALUES (2, 'lansnow', '$2a$10$CMAlw3pPPi89KSfi6lJm6.Nfzu5BMlqU.DCCsKRRf9oOP1vkCk3we', 'lansnow', '15901945122', 0, '', '', '2', 'xxxxxxx@xxx.com', 11, 0, '这里没有其它的信息了', '2', 0, 0, '2022-03-03 10:22:24.923', '2022-03-03 10:22:24.923', NULL);
INSERT INTO `sys_user` VALUES (3, 'xxxxxx', 'xxxxxx', 'xxxxxx', '15901945150', 0, '', '', '2', 'yyyyy@yyyy.com', 11, 0, '帐号密码一致', '2', 0, 0, '2022-03-03 10:26:11.217', '2022-03-03 10:26:11.217', NULL);
INSERT INTO `sys_user` VALUES (4, '15901945155', '$2a$10$/Glr4g9Svr6O0kvjsRJCXu3f0W8/dsP3XZyVNi1019ratWpSPMyw.', '张三丰333', '15901945155', 0, 's_xwEcW]^$~8HJxh', 'http://192.168.1.3:8000/static/uploadfile/30c3629ae8e96cf273a21031fc7beb9a.png', '', '', 0, 0, '', '2', 0, 0, '2022-03-07 11:13:44.936', '2022-03-24 11:35:10.636', NULL);
INSERT INTO `sys_user` VALUES (5, '17717356757', '', '17717356757', '17717356757', 0, '', '', '', '', 11, 0, '', '2', 0, 0, '2022-03-14 17:06:00.762', '2022-03-14 17:06:00.762', NULL);
INSERT INTO `sys_user` VALUES (9, '15901945151', '$2a$10$iweKE3GEHQpPG.2Tv1wTl.b3FJbFWucWJNBBHAriBRucKNGz6a.fi', '15901945151', '15901945151', 0, '', '', '', '', 0, 0, '', '2', 0, 0, '2022-03-25 01:02:55.236', '2022-03-25 01:19:05.636', NULL);
...
CREATE TABLE `sys_video`  (
  ...
  `conver` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '视频封面',
  `duration` int(0) NULL DEFAULT NULL COMMENT '时长为秒',
  `created_at` timestamp(3) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `sys_video` VALUES (1, 1, 271296349, 'http://192.168.1.3:8000/static/uploadfile/96b56d6f-ff7a-4b12-b538-1040cd71fb53.mp4', 'http://192.168.1.3:8000/static/uploadfile/5d60a1ec-7a87-461e-adcd-f9e0abed84ae.jpg', 1000, '2022-03-21 08:46:55.768');
INSERT INTO `sys_video` VALUES (3, 4, 271296349, 'http://192.168.1.3:8000/static/uploadfile/0958d9a5-b9fd-493b-885d-300bac0ad76c.mp4', 'http://192.168.1.3:8000/static/uploadfile/703a4036-fdb3-4ac4-82c7-76271db93a4e.jpg', 1000, '2022-03-21 08:56:58.831');
