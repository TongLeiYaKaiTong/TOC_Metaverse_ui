    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              v-permisaction="['admin:sysVideo:remove']"
              type="danger"
              icon="el-icon-delete"
              size="mini"
              :disabled="multiple"
        ...
        >
          ...
          <el-table-column label="原始数字人" width="200" :show-overflow-tooltip="true" align="center">
            <template slot-scope="scope">
              <el-link type="primary" :href="scope.row.conver" target="_blank">{{ scope.row.conver }}</el-link>
            </template>
          </el-table-column>
          <el-table-column label="视频" width="200" :show-overflow-tooltip="true" align="center">
            <template slot-scope="scope">
...
<script>
import { listVideoApi, deleteVideoApi } from '@/api/admin/sys-video'
