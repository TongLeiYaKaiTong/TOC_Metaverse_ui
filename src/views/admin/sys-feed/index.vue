...
<script>
import { addFeedApi, delFeedApi, getFeedApi, listFeedApi, updateFeedApi } from '@/api/admin/sys-feed'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listFeedApi(this.queryParams).then(response => {
        this.sysFeedList = response.data.list
